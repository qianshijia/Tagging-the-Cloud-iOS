...
- (void)viewDidLoad
{
    ...
    NSDictionary *dicTemp1 = [[NSDictionary alloc] 
                              initWithObjectsAndKeys:arrTemp1, @"1", arrTemp2, @"2", 
                              arrTemp3, @"3", arrTemp4, @"4", nil];
    NSArray *arrTemp = [[NSArray alloc] initWithObjects:@"1", @"2", @"3", @"4", nil];
    self.sectionContents = dicTemp1;
    self.sectionTitles = arrTemp;
    [dicTemp1 release];
    [arrTemp release];
    [arrTemp1 release];
    [arrTemp2 release];
...
{ 
    ...
    if(cell == nil)
    {
        ...
        {
            cell.backgroundColor = [TagitUtil getColor:@"C43434"];
